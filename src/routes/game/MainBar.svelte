...
<nav {...$$restProps}>
	<div class="flex flex-col px-8 py-3 rounded">
		<header>
		...
		<footer>
			<span>
				<b>{addcomma($_game.moneyup)}</b>
				<span>Coins</span>
				<span>/ click</span>
				|
				<b>{addcomma($_game.msec)}</b>
				<span>Coins</span>
				<span>/ sec</span>
			</span>
		</footer>
...
<style>
	...
	header {
		@apply flex font-bold items-center justify-end leading-tight text-8xl;
	}
	footer {
