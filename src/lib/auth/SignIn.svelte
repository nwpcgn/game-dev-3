...
<section {...$$restProps}>
	<form
		class="w-full max-w-sm p-4 space-y-3 mx-auto text-center"
		...
		<figure class="mb-4 text-gray-500">
			...
			<figcaption class="font-light py-1 text-sm">Anmelden</figcaption>
		</figure>
		...
		<button on:click={resetForm} class="w-full btn btn-gray mb-2" type="reset"
			>Clear</button>
